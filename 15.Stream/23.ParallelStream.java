...
public class ParallelStream
{
    public static void main(String[] args)
    {
        ...
        MalePerson malePerson = list.parallelStream()       // parallel로 병렬 처리 스트림을 사용한다.
                ...
                .collect(
                        ...
                        (r1, r2) -> r1.Combine(r2)          // 클래스가 입력이 되면 입력된 클래스의 리스트를 연결하는 작업을 한다.
                                                            // 병렬처리를 하면 여러개의 클래스가 생성되므로 Combine이 호출된다.
                );
